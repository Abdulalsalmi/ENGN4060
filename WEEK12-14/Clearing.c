	    ...
	    if(counter == 40){
	              	...
	              	for (row=0;row<6;row++){
	              		for(column=0;column<6;column++){
	              			...
	              			if (select[row][column]==0){
	              				alt_up_pixel_buffer_dma_draw_vline(hPB, (row*32)+5, (column*32)+47, (column*32)+78, 0x00,0);
	              				alt_up_pixel_buffer_dma_draw_vline(hPB, (row*32)+36, (column*32)+47, (column*32)+78, 0x00,0);

	              				alt_up_pixel_buffer_dma_draw_hline(hPB, (row*32)+5,(row*32)+36, (column*32)+47, 0x00,0);
	              				alt_up_pixel_buffer_dma_draw_hline(hPB, (row*32)+5,(row*32)+36, (column*32)+78, 0x00,0);
