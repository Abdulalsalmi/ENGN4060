...
arr=np.uint8(arr)
im1 = plt.imread("2.bmp")
arr1 = np.random.rand(32,32)
arr1=np.uint8(arr1)
im2 = plt.imread("3.bmp")
arr2 = np.random.rand(32,32)
arr2=np.uint8(arr2)
im3 = plt.imread("4.bmp")
arr3 = np.random.rand(32,32)
arr3=np.uint8(arr3)
im4 = plt.imread("5.bmp")
arr4 = np.random.rand(32,32)
arr4=np.uint8(arr4)
im5 = plt.imread("6.bmp")
arr5 = np.random.rand(32,32)
arr5=np.uint8(arr5)
im6 = plt.imread("7.bmp")
arr6 = np.random.rand(32,32)
arr6=np.uint8(arr6)
im7 = plt.imread("8.bmp")
arr7 = np.random.rand(32,32)
arr7=np.uint8(arr7)
im8 = plt.imread("9.bmp")
arr8 = np.random.rand(32,32)
arr8=np.uint8(arr8)
im9 = plt.imread("10.bmp")
arr9 = np.random.rand(32,32)
arr9=np.uint8(arr9)
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON02[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr2[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON03[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr3[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON04[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr4[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON05[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr5[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON06[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr6[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON07[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr7[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON08[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr8[r][c])
...
for r in range (32):
    ...
    r=r+1
with open('ICON.h','a') as fp:
    fp.write("unsigned int ICON09[32][32] = { \n")  
    for r in range (32):
        fp.write("{")
        for c in range (32):
            x=(arr9[r][c])
